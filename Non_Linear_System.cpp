// #ifndef Non_Linear_System_hpp
// #define Non_Linear_System_hpp
...
Matrix function_f(Matrix x) {
	...
	f.matrix[0][0] = pow(x.matrix[0][0], 2) - pow(x.matrix[1][0], 2);
	f.matrix[1][0] = 2 * x.matrix[0][0] * x.matrix[1][0] - 1;
...
Matrix Jacobian_matrix(Matrix x) {
	...
	J.matrix[0][0] = 2 * x.matrix[0][0];
	J.matrix[0][1] = -2 * x.matrix[1][0];
	J.matrix[1][0] = 2 * x.matrix[1][0];
	J.matrix[1][1] = 2 * x.matrix[0][0];
